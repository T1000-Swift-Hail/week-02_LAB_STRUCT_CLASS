...
func printDescription(name : String
                      ...
                      , weather : String
                      , population : Int) {
    print("this city name\(name) and population \(population) and location \(location) and geology \(geology) and weather \(weather ) ")
}}
...
func printDescription() {
    ...
    for city in cities{
        ...
        city.printDescription(name: city.name, location: city.location, geology: city.geology, weather: city.weather,
...
saudiArabia.cities.append(contentsOf: [first,second,third,fourth,fifth])
